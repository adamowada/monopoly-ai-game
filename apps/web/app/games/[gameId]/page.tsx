    ...
    <main className="min-h-screen bg-[var(--color-page)] text-neutral-950">
      <header className="border-b border-neutral-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            <p className="text-xs font-semibold uppercase text-teal-700">Phase 5 Stage 5.6</p>
            <h1 className="mt-1 text-2xl font-semibold tracking-normal">Game board {game.id}</h1>
            <p className="mt-2 text-sm text-neutral-600">
              Legal action controls, auctions, property management, and negotiation deal building backed by the FastAPI referee.
            </p>
          </div>
