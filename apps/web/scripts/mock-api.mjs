  ...
  game.ai_decisions = [
    {
      ...
      prompt_context: {
        ...
        note: "Private local AI audit for server-owned decisions, memory, self-dialogue, and rejected outputs.",
      },
      raw_output:
  ...
  game.ai_self_dialogue = [
    {
      ...
      payload: {
        status: "provided",
        text: "Legal actions snapshot has ROLL_DICE and DECLARE_BANKRUPTCY; bankruptcy is not appropriate.",
      },
    ...
    },
    {
      ...
      payload: {
        status: "provided",
        text: "Memory entries and retrieved context records do not change the legal action boundary.",
      },
      created_at: dialogueAt,
    },
  ];
