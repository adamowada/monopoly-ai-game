...
def _cash_starved_railroad_near_set_state(game_id: UUID) -> GameState:
    state = _railroad_near_set_state(game_id)
    players = [player.model_dump(mode="python") for player in state.players]
    players[0]["cash"] = 450
    ownership = [item.model_dump(mode="python") for item in state.property_ownership]
    return _state_with_debug_values(state, players=players, ownership=ownership)
...
def _cash_starved_opponent_orange_near_monopoly_state(game_id: UUID) -> GameState:
    state = _opponent_orange_near_monopoly_state(game_id)
    players = [player.model_dump(mode="python") for player in state.players]
    players[0]["cash"] = 350
    ownership = [item.model_dump(mode="python") for item in state.property_ownership]
    return _state_with_debug_values(state, players=players, ownership=ownership)
